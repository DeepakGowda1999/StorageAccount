...
namespace StorageAccount.Repository
{
    ...
    {
        public static string connectionString="DefaultEndpointsProtocol=https;AccountName=storageaccount12demo1999;AccountKey=UmsRYHf5FCAjWiECopl42iufgEsf9W712Cqj8KOt/P0j1Mw3rythdMTtj8CaxWYiNKBKRNwT75R7+ASt3pZ0jw==;EndpointSuffix=core.windows.net";
        ...
        {
            string path=@"C:\Users\M1084126\Desktop\IotStorage\StorageAccount\Downloads\"+fileName;
            shareServiceClient=new ShareServiceClient(connectionString);
            var serviceClient=shareServiceClient.GetShareClient(fileShareName);
            var dir=serviceClient.GetDirectoryClient(directoryName);
            var file=dir.GetFileClient(fileName);
